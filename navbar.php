  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      <li class="nav-item <?php echo basename($_SERVER['PHP_SELF']) == 'index.php' ? 'active' : ''; ?>">
        <a class="nav-link" href="index.php">Strona główna / Dodaj książkę</a>
      </li>
      <li class="nav-item <?php echo basename($_SERVER['PHP_SELF']) == 'view_books.php' ? 'active' : ''; ?>">
        <a class="nav-link" href="view_books.php">Moja Biblioteka</a>
      </li>
      <li class="nav-item <?php echo basename($_SERVER['PHP_SELF']) == 'reading_books.php' ? 'active' : ''; ?>">
        <a class="nav-link" href="reading_books.php">Przeczytane Książki</a>
      </li>
